      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center px-6">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <p className="text-muted-foreground leading-relaxed max-w-xl mx-auto">We started Meeggra Naturals with a simple belief: everyone deserves access to clean, effective skincare and haircare — without paying luxury prices or compromising on quality.</p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
              ...
              <p>So we built Meeggra Naturals — a brand that strips away the pretense and focuses on what matters: natural, effective formulations that work for real people living real lives.</p>
