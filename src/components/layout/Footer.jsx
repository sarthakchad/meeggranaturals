...
export default function Footer() {
  ...
  const handleSubscribe = async (e) => {
    ...
    toast.success("Welcome to the Meeggra Naturals family!");
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          <div className="lg:col-span-1">
            <h2 className="font-display text-2xl tracking-editorial mb-4">MEEGGRA NATURALS</h2>
        ...
        <div className="mt-16 pt-8 border-t border-background/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-background/40">© {new Date().getFullYear()} Meeggra Naturals. All rights reserved.</p>
